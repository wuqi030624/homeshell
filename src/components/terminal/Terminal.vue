...
import CommandOutputType = HomeShell.CommandOutputType;
import OutputType = HomeShell.OutputType;
import CommandInputType = HomeShell.CommandInputType;
import { registerShortcuts } from "./shortcuts";
import TerminalType = HomeShell.TerminalType;
import TextOutputType = HomeShell.TextOutputType;
import useHistory from "./history";
import ContentOutput from "./ContentOutput.vue";
import OutputStatusType = HomeShell.OutputStatusType;
...
onMounted(() => {
  ...
  if (welcomeTexts?.length > 0) {
    ...
    terminal.writeTextOutput(
      `Welcome to HomeShell - Your smart browser homepage!` +
        `<a href="//github.com/yourusername/homeshell" target='_blank'> GitHub</a>`
    );
    terminal.writeTextOutput(
      `Type 'help' to get started or press Ctrl+\` to toggle terminal`
    );
